...
function App() {
  ...
  return (
    <div className="bg-slate-300 font-outfit text-[15px] w-full h-screen flex justify-center items-center ">
      <div className="bg-white w-1/5 rounded-lg p-3 flex-col justify-center items-center">
        ...
        <div class="attribution" className="pt-1 text-center">
          Challenge by <a href="https://www.frontendmentor.io?ref=challenge" className="text-slate-600" target="_blank">Frontend Mentor</a>. 
